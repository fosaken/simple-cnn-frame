...
__all__ = ["MobileNet", "mobilenetv1_025", "mobilenetv1_05", "mobilenetv1_075", "mobilenetv1_1", "mobilenetv1_2"]
...
class MobileNet(nn.Module):
    def __init__(self, widen_factor=1.0, **kwargs):
        """ Constructor
        Args:
...
def mobilenetv1_2(**kwargs):
    model = MobileNet(widen_factor=2.0, **kwargs)
    return model


def mobilenetv1_1(**kwargs):
    model = MobileNet(widen_factor=1.0, **kwargs)
    return model


def mobilenetv1_075(**kwargs):
    model = MobileNet(widen_factor=0.75, **kwargs)
    return model


def mobilenetv1_05(**kwargs):
    model = MobileNet(widen_factor=0.5, **kwargs)
    return model


def mobilenetv1_025(**kwargs):
    model = MobileNet(widen_factor=0.25, **kwargs)
    return model
